...
const SaasRegistration = () => {
  ...
  const text = (
    <div>
      <p>
        BoxyHQ, the leading provider of security building blocks for developers
      ...
      <ul>
        ...
        <li>
          <b>Full Support:</b> BoxyHQ is committed to providing exceptional
          support to its customers, ensuring a smooth onboarding process and
          continued assistance throughout their journey
        </li>
        <li>
          <b>Unmatched Flexibility:</b> The platform offers customizable
          options, allowing businesses to tailor the solution to their unique
      ...
      <p>
        ...
        join the waitlist for the SaaS platform and enjoy a remarkable 50% off
        the first year's subscription. By signing up before August 1, businesses
        can take advantage of this limited-time offer and unlock the full
        potential of BoxyHQ's revolutionary solution.
      </p>
      <br></br>
      <p>
        ...
        businesses are encouraged to fill out the form. Simply provide your
        Name, Email, Product of interest, and potential date of implementation.
      ...
      <p>
        ...
        remarkable results. With a team of experts and a commitment to
        innovation, BoxyHQ is revolutionizing the way businesses work, making
  ...
  return (
    <Layout title={title} description={description}>
      <HeroSection
        ...
        buttons={
          [
            //added multiple buttons to page
          ]
        }
      />
