...
const Terms = () => {
  const metaDescription =
    'Review the Terms and Conditions of BoxyHQ. Understand your rights and responsibilities as a user of our services, including detailed policy information on usage, privacy, and more to ensure a clear and transparent relationship.';
  ...
  return (
    ...
    >
      <main className="girdle legal-page">
        ...
        <p>
          This agreement constitutes a binding legal contract between BoxyHQ
          Inc. ("BoxyHQ Inc.") (sometimes referred to as "we", "us" or "our")
          and you, with respect to your use of{' '}
          <a href="https://boxyhq.com">https://boxyhq.com</a> and all websites,
        ...
        <ol className="legal-ordered-list">
          <li>
            ...
            not be liable to you or any third party for any modiﬁcation,
        ...
        <ol className="legal-ordered-list">
          ...
          <li>
            You agree that by registering an account with us that you: all
          ...
          <li>
            ...
            party, for any loss or damage suﬀered because of this.
          </li>
        </ol>
        ...
        <ol className="legal-ordered-list">
          <li>
            ...
            (including all applicable taxes) at the prices then in eﬀect for
            your purchases.
          </li>
          <li>
        ...
        <p>
          ...
          duration of the free trial period, we may at our sole discretion: (i)
          limit your ability to access certain features; (ii) limit any
        ...
        <ol className="legal-ordered-list">
          <li>
            ...
            speciﬁcations to enable you to have the best possible experience of
            our Site.
          </li>
          <li>
            We may from time to time, at our sole discretion and without notice
            to you, make variations, modiﬁcations, alterations or updates to our
            Site ("Enhancements"). These Enhancements may be made to improve our
            Site to you or to comply with relevant legal requirements.
          </li>
          <li>
        ...
        <ol className="legal-ordered-list">
          <li>
            ...
            BoxyHQ Inc. (the "Materials") and its licensors.
          </li>
          <li>
        ...
        <ol className="legal-ordered-list">
          ...
          <li>
            Provided your rights are not aﬀected under these Terms and
        ...
        <h2>Exclusion of Implied Relationships</h2>
        <p>
          ...
          partnership unless speciﬁcally otherwise provided. We do not owe you
        ...
        <p>
          ...
          shall not aﬀect the validity and enforceability of the remaining
        ...
        <p>
          ...
          accordance with Delaware law. Both parties agree to submit to the
          jurisdiction of the courts of Delaware with respect to any claim or
